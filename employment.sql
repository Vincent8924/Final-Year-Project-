...
---------------------------------------------------------------------------------------------------
  ...
  INSERT INTO sale (sale_id, purchase_amount, payment_status, employer_id, package_id,bank,card_name,card_numberq,card_expire_year,card_expire_month,card_cvv) VALUES (300001, 49.99, 'Successful', 1, 200001,'CIMB',"Vincent's Card",1111000011110000,2028,05,123);
